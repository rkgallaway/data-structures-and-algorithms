...
const addNumbers = (num, arr, times, callback) => {
  // Solution code here...
  // num is value added to the array however many 'times' you 'callback' --how do I write that?!
...
//not working, but basically my logic is:  for the number of 'times' im going to run the callback...  
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
//my thinking is that I'm going to divide by 3 and if the remainder is 2, then I'm going to pop an element off of the array
...
//my thinking is that I want to cycle thru entire array and pop off an element every time I have a remainder of 2
